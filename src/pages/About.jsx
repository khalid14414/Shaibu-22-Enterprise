...
function About() {
  return (
    <div className="about">
        <div className="max-w-6xl mx-auto  mb-12 bg-green-900 text-white text-center py-12">
          <h1 className="text-4xl md:text-5xl font-bold">About Shaibu 22 Enterprise</h1>
          <p className="mt-4">Empowering Africa with natural solutions to combat malaria.</p>
        </div>
      <OurStory />
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    {/* Founder Section */}
    <div className="mt-32 bg-gradient-to-br from-green-50 to-white rounded-3xl shadow-2xl overflow-hidden">
