  ...
  return (
    <section className="bg-green-50 py-16" id="product-feature">
        <div className="max-w-7xl mx-auto px-6 text-center" >
            <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-4">Our Organic Products</h2>
            <p className="text-gray-600 mb-12 max-w-2xl mx-auto">Explore our premium, organic health solutions that keep you protected and refreshed—naturally.</p>
            <div className="grid gap-12 md:grid-cols-2 ">
                {product.map((item, index) => (
                    <div key={index} className="bg-white p-6 rounded-2xl shadow hover:shadow-xl transition  duration-300 text-left">
                        ...
                        <h3 className="text-xl font-semibold text-green-700 mb-2">{item.name}</h3>
